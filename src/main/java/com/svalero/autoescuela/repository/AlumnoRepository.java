...
public interface AlumnoRepository extends CrudRepository<Alumno, Long>{
    ...
    // 3 filtros
    List<Alumno> findByNombreAndCiudadAndUsaGafas(
            String nombre, String ciudad, Boolean usaGafas);

    List<Alumno> findByNombreAndCiudadAndNotaTeorico(
            String nombre, String ciudad, Float notaTeorico);

    List<Alumno> findByNombreAndUsaGafasAndNotaTeorico(
            String nombre, Boolean usaGafas, Float notaTeorico);

    List<Alumno> findByCiudadAndUsaGafasAndNotaTeorico(
            String ciudad, Boolean usaGafas, Float notaTeorico);

    // 4 filtros
    List<Alumno> findByNombreAndCiudadAndUsaGafasAndNotaTeorico(
            String nombre, String ciudad, Boolean usaGafas, Float notaTeorico);
